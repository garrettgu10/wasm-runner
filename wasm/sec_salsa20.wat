(module
  ...
  (func $salsa20 untrusted 
    ...
    (set_local $l0 (tee_local $c0 (s32.load (i32.const 0))))
    (set_local $l1 (tee_local $c1 (s32.load (i32.const 4))))
    (set_local $l2 (tee_local $c2 (s32.load (i32.const 8))))
    (set_local $l3 (tee_local $c3 (s32.load (i32.const 12))))
    (set_local $l4 (tee_local $c4 (s32.load (i32.const 16))))
    (set_local $l5 (tee_local $c5 (s32.load (i32.const 20))))
    (set_local $l6 (tee_local $c6 (s32.load (i32.const 24))))
    (set_local $l7 (tee_local $c7 (s32.load (i32.const 28))))
    (set_local $l8 (tee_local $c8 (s32.load (i32.const 32))))
    (set_local $l9 (tee_local $c9 (s32.load (i32.const 36))))
    (set_local $l10 (tee_local $c10 (s32.load (i32.const 40))))
    (set_local $l11 (tee_local $c11 (s32.load (i32.const 44))))
    (set_local $l12 (tee_local $c12 (s32.load (i32.const 48))))
    (set_local $l13 (tee_local $c13 (s32.load (i32.const 52))))
    (set_local $l14 (tee_local $c14 (s32.load (i32.const 56))))
    (set_local $l15 (tee_local $c15 (s32.load (i32.const 60))))
    ;; bit-muck
